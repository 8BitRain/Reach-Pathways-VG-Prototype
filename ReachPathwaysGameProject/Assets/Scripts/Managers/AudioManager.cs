...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField]
    public EventReference menuMusic, gameplayMusic, overworldMusic, menuSelect, menuBack, mouseOver, playCard, drawCard, scenarioCard, negEffect, posEffect, roundFail, roundSucceed, diceRoll, restClick;
